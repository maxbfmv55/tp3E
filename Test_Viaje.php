...
while ($opcion != 10) {
    ...
    switch ($opcion) {
        ...
        case 7:
            ...
            $documento = trim(fgets(STDIN));
            $eliminar = $viaje->eliminarPasajero($documento);
            if ($eliminar) {
        ...
        case 8:
            ...
            $objResponsableViaje = new ResponsableViaje($numeroEmpleado, $numeroLicencia, $nombreEmpleado, $apellidoEmpleado);
            $verifica = $viaje->agregarResponsable($objResponsableViaje);
            if ($verifica) {
